        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            <div className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#B6E324]/10 text-[#B6E324] text-xs font-mono">
                <span className="w-2 h-2 rounded-full bg-[#B6E324] animate-pulse" />
                LIVE
              </span>
